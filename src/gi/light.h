...
class Light {
  public:
     ...
     */
    virtual std::tuple<glm::vec3, Ray, glm::vec3, float, float> sample_Le(
        const glm::vec2& sample_pos, const glm::vec2& sample_dir
    ) const = 0;

    virtual std::tuple<float, float> pdf_Le(
        const SurfaceHit& light, const glm::vec3& dir
    ) const = 0; // currently unused
...
class AreaLight : public Light {
  public:
    ...
    std::tuple<glm::vec3, Ray, glm::vec3, float, float> sample_Le(
        const glm::vec2& sample_pos, const glm::vec2& sample_dir
    ) const;
...
class SkyLight : public Light {
  public:
    ...
    void load(
        const std::filesystem::path& path, const glm::vec3& scene_center, float scene_radius, float intensity = 1.f
    );
