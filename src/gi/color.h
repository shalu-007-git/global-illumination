...
inline glm::vec3 rgb_to_xyz(const glm::vec3& rgb) {
    const glm::mat3 transform(
        glm::vec3(0.4124, 0.2126, 0.0193), glm::vec3(0.3576, 0.7152, 0.1192), glm::vec3(0.1805, 0.0722, 0.9505)
    );
...
inline glm::vec3 xyz_to_rgb(const glm::vec3& xyz) {
    const glm::mat3 transform(
        glm::vec3(3.2406, -0.9689, 0.0557), glm::vec3(-1.5372, 1.8758, -0.2040), glm::vec3(-0.4986, 0.0415, 1.0570)
    );
...
inline glm::vec3 saturate(const glm::vec3& col) {
    return clamp(col, glm::vec3(0), glm::vec3(1));
}
...
inline glm::vec3 ACESFitted(const glm::vec3& rgb) {
    ...
    static const glm::mat3 ACESInputMat(
        glm::vec3(0.59719, 0.35458, 0.04823), glm::vec3(0.07600, 0.90834, 0.01566), glm::vec3(0.02840, 0.13383, 0.83777)
    );
    // ODT_SAT => XYZ => D60_2_D65 => sRGB
    static const glm::mat3 ACESOutputMat(
        glm::vec3(1.60475, -0.53108, -0.07367),
        glm::vec3(-0.10208, 1.10813, -0.00605),
        glm::vec3(-0.00327, -0.07276, 1.07602)
    );
