...
class BRDF {
  public:
     ...
     */
    virtual std::tuple<glm::vec3, glm::vec3, float> sample(
...
class LambertianReflection : public BRDF {
  public:
    LambertianReflection()
        : BRDF(BRDFType(BRDF_DIFFUSE | BRDF_REFLECTION)) {}
    glm::vec3 f(const SurfaceHit& hit, const glm::vec3& w_o, const glm::vec3& w_i) const;
    std::tuple<glm::vec3, glm::vec3, float> sample(
        const SurfaceHit& hit, const glm::vec3& w_o, const glm::vec2& sample
    ) const;
...
class LambertianTransmission : public BRDF {
  public:
    LambertianTransmission()
        : BRDF(BRDFType(BRDF_DIFFUSE | BRDF_TRANSMISSION)) {}
    glm::vec3 f(const SurfaceHit& hit, const glm::vec3& w_o, const glm::vec3& w_i) const;
    std::tuple<glm::vec3, glm::vec3, float> sample(
        const SurfaceHit& hit, const glm::vec3& w_o, const glm::vec2& sample
    ) const;
...
class SpecularReflection : public BRDF {
  public:
    SpecularReflection()
        : BRDF(BRDFType(BRDF_SPECULAR | BRDF_REFLECTION)) {}
    glm::vec3 f(const SurfaceHit& hit, const glm::vec3& w_o, const glm::vec3& w_i) const;
    std::tuple<glm::vec3, glm::vec3, float> sample(
        const SurfaceHit& hit, const glm::vec3& w_o, const glm::vec2& sample
    ) const;
...
class SpecularTransmission : public BRDF {
  public:
    SpecularTransmission()
        : BRDF(BRDFType(BRDF_SPECULAR | BRDF_TRANSMISSION)) {}
    glm::vec3 f(const SurfaceHit& hit, const glm::vec3& w_o, const glm::vec3& w_i) const;
    std::tuple<glm::vec3, glm::vec3, float> sample(
        const SurfaceHit& hit, const glm::vec3& w_o, const glm::vec2& sample
    ) const;
...
/**
 * @brief BRDF combining a perfect specular relfection and transmission via the fresnel factor. F.e. used to simulate
 * glass.
 */
class SpecularFresnel : public BRDF {
  public:
    SpecularFresnel()
        : BRDF(BRDFType(BRDF_SPECULAR | BRDF_REFLECTION | BRDF_TRANSMISSION)) {}
    glm::vec3 f(const SurfaceHit& hit, const glm::vec3& w_o, const glm::vec3& w_i) const;
    std::tuple<glm::vec3, glm::vec3, float> sample(
        const SurfaceHit& hit, const glm::vec3& w_o, const glm::vec2& sample
    ) const;
...
class SpecularPhong : public BRDF {
  public:
    SpecularPhong()
        : BRDF(BRDFType(BRDF_GLOSSY | BRDF_REFLECTION)) {}
    glm::vec3 f(const SurfaceHit& hit, const glm::vec3& w_o, const glm::vec3& w_i) const;
    std::tuple<glm::vec3, glm::vec3, float> sample(
        const SurfaceHit& hit, const glm::vec3& w_o, const glm::vec2& sample
    ) const;
...
class MicrofacetReflection : public BRDF {
  public:
    MicrofacetReflection(bool coated = false)
        : BRDF(BRDFType(BRDF_GLOSSY | BRDF_REFLECTION)), coated(coated) {}
...
class MicrofacetTransmission : public BRDF {
  public:
    MicrofacetTransmission(bool coated = false)
        : BRDF(BRDFType(BRDF_GLOSSY | BRDF_TRANSMISSION)), coated(coated) {}
    virtual glm::vec3 f(const SurfaceHit& hit, const glm::vec3& w_o, const glm::vec3& w_i) const;
    std::tuple<glm::vec3, glm::vec3, float> sample(
        const SurfaceHit& hit, const glm::vec3& w_o, const glm::vec2& sample
    ) const;
...
class LayeredSurface : public BRDF {
  public:
    LayeredSurface()
        : BRDF(BRDFType(BRDF_DIFFUSE | BRDF_GLOSSY | BRDF_REFLECTION)), diff(), spec(true) {}
    glm::vec3 f(const SurfaceHit& hit, const glm::vec3& w_o, const glm::vec3& w_i) const;
    std::tuple<glm::vec3, glm::vec3, float> sample(
        const SurfaceHit& hit, const glm::vec3& w_o, const glm::vec2& sample
    ) const;
